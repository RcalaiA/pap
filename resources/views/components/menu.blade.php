        ...
        <div class="container mx-auto flex flex-wrap items-center justify-between p-4">
            ...
            <div class="hidden md:block w-full md:w-auto" id="mobile-menu">
                <ul class="flex flex-col md:flex-row md:space-x-8 mt-4 md:mt-0 md:text-sm md:font-medium">
                    <li><a href="http://localhost:8000/sobre" class="bg-blue-700 md:bg-transparent text-white block pl-3 pr-4 py-2 md:text-blue-700 md:p-0 rounded">Sobre nós</li>
                    <li>
                    ...
                    <li><a href="#" class="text-gray-700 hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-blue-700 md:p-0">Noticias</a></li>
